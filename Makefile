...
ACLOCAL = ${SHELL} /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf/missing autoconf
AUTOHEADER = ${SHELL} /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf/missing autoheader
AUTOMAKE = ${SHELL} /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf/missing automake-1.15
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -march=x86-64 -mtune=native -O2 -pipe -fstack-protector-strong --param=ssp-buffer-size=4 -Wextra -Werror-implicit-function-declaration -fno-tree-pre -Wall -Wno-unused-parameter -std=gnu99 -march=native -DHAVE_LIBNET11 -D_BSD_SOURCE -D__BSD_SOURCE -D__FAVOR_BSD -DHAVE_NET_ETHERNET_H -DHAVE_LIBNET_ICMPV6_UNREACH  -I/usr/include -DLIBPCAP_VERSION_MAJOR=1 -DHAVE_PCAP_SET_BUFF -DHAVE_PFRING -D__SC_CUDA_SUPPORT__ -DHAVE_LIBCAP_NG -DREVISION="bc2c7f4"
CPP = gcc -std=gnu99 -E
CPPFLAGS = -D_FORTIFY_SOURCE=2 -I/opt/cuda/include/ -I/usr/include/nspr  -I/usr/include/nss -I/usr/include/nspr 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LDFLAGS = -Wl,-O1,--sort-common,--as-needed,-z,relro -L/opt/cuda/lib64/
LIBHTPDEVVERSION_CFLAGS = 
LIBHTPDEVVERSION_LIBS = 
LIBHTPMINVERSION_CFLAGS = -I/usr/include/htp -I/usr/lib/htp/include 
...
LIBS = -lGeoIP -lmagic -lnss3 -lnspr4 -lcap-ng -lcuda -lhtp -lpfring -lpcap -lnet -lnfnetlink -ljansson -lpthread -lyaml -lpcre -lrt -lnuma -lrt -lnuma -lplds4 -lplc4 -lnspr4  -lssl3 -lsmime3 -lnss3 -lnssutil3 -lplds4 -lplc4 -lnspr4 
...
LUA_CFLAGS = 
LUA_LIBS = 
MAKEINFO = ${SHELL} /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = suricata 2.1dev
PACKAGE_TARNAME = suricata
PACKAGE_URL = 
PACKAGE_VERSION = 2.1dev
PATH_SEPARATOR = :
...
STRIP = strip
VERSION = 2.1dev
abs_builddir = /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf
abs_srcdir = /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf
abs_top_builddir = /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf
abs_top_srcdir = /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/lin/source.build/suricata-cuda/suricata-pfring-git/src/oisf/install-sh
...
libnss_LIBS = -lssl3 -lsmime3 -lnss3 -lnssutil3 -lplds4 -lplc4 -lnspr4 
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/suricata
pkgpythondir = ${pythondir}/suricata
prefix = /usr
